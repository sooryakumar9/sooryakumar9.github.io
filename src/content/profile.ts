...
export const profile = {
  ...
  statement: [
    ...
    "The range shows in the work. A web control layer for a defence simulation lab. A document intelligence pipeline. A quantum resistant messaging experiment. Two products on the bench. Different systems, one habit: understand the whole thing, then build it properly.",
  ],
  marginNotes: [
